              ...
              assetmanager.retrieveAsset({ _id: result._assetId }, function (error, assets) {
                ...
                if (!processedAssets[asset.filename]) {
                  ...
                  for (var i = 0; i < jsonObject['contentobject'].length; i++) {
                    ...
                    if (jsonObject['contentobject'][i].hasOwnProperty('_media') && jsonObject['contentobject'][i]._media.hasOwnProperty('mp4')
                      && jsonObject['contentobject'][i]._media.mp4 == "course/assets/" + asset.filename) {
